...
if( function_exists( 'wp_get_theme' ) ) {
	...
	$theme_data = get_theme_data( BMD_SERVER_PATH.'/style.css' );
...
define( 'ADMIN_PATH', BMD_SERVER_PATH . '/options/admin/' );
define( 'ADMIN_DIR', get_template_directory_uri() . '/options/admin/' );
