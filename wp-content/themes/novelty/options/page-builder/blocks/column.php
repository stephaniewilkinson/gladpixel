<?php
/** A simple text block **/
class BMD_Column_Block extends AQ_Block {
	...
	function __construct() {
		...
		//create the widget
		parent::__construct('bmd_column_block', $block_options);
	...
	function form_callback($instance = array()) {
		...
		if(isset($template_id)) {
			echo '<li id="template-block-'.$number.'" class="block block-bmd_column_block '.$size.'">',
	...
	function after_form($instance) {
		...
		$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
			...
			echo '<a href="#" class="block-plus"><i class="icon-plus-sign"></i></a>';
	 		echo '<a href="#" class="block-minus"><i class="icon-minus-sign"></i></a>';
	 		echo '<a href="#" class="col-delete"><i class="icon-trash"></i></a>';
