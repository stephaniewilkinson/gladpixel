...
if ($wp_query->have_posts()) : while($wp_query->have_posts()) : $wp_query->the_post(); 
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('portfolio-single portfolio-center text-center ' . $portflio_single_link); ?>>
				
		<div class="portfolio-single-items <?php echo $shadow; ?>">
